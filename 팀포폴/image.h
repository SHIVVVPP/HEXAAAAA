...
public:
	...
	//	 프레임 렌더 
	void frameRender(HDC hdc, int destX, int destY, int width, int height, int currentFrameX, int currentFrameY);
	...
	void aniRender(HDC hdc, int destX, int destY, int width, int height, animation* ani);
