...
void Sepp::render()
{
	...
	{
		if (_imgName2 == "서빙")IMAGEMANAGER->findImage(_imgName2)->frameRender(getMemDC(), CAMERAMANAGER->CameraRelativePoint(_imgrc).x-170, CAMERAMANAGER->CameraRelativePoint(_imgrc).y+45 , crrentx, crrenty);
