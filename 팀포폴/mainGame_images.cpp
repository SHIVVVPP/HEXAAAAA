...
void mainGame::setImages()
{
	...
	IMAGEMANAGER->addFrameImage("playerAttack", "image//character//playerAtk.bmp", 1000, 500, 4, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("playerDownAttack", "image//character//playerDownAtk.bmp", 250, 500, 1, 2, true, RGB(255, 0, 255));
