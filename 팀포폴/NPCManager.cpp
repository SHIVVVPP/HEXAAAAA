...
void NPCManager::setNpc()
{
	...
	NPC* _wizard;
	_wizard = new Wizard;
	_wizard->init("¸¶¹ı»ç", PointMake(3710, 365), "./text/NPC/À§ÀÚµå.txt", "./text/NPC/À§ÀÚµå1.txt", false, false, true, true);

	NPC* _cooker;
	_cooker = new Sepp;
	_cooker->init("¿ä¸®»ç", PointMake(2935,	280), "./text/NPC/¿ä¸®»ç.txt", "./text/NPC/¿ä¸®»ç1.txt", false, false, true, false);
